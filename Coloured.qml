...
Rectangle{
    ...
    property var flag :0
    signal songClicked(string songName)
    Rectangle{
        id:ocean
        ...
        Rectangle{
            anchors.top: ocean.bottom
            anchors.left: ocean.left
            anchors.right: ocean.right
            width: parent.width-50
            height: 2
            color: oceanmouse.containsMouse?"White":"transparent"
    ...
    Image{
        ...
        anchors.left: ocean.right
        anchors.leftMargin: -4
        anchors.top: ocean.top
        anchors.topMargin: 10
        visible: oceanmouse.containsMouse?true:false
    }
    Rectangle{
        id:song2
        anchors.top: ocean.bottom
        ...
        MouseArea{
            ...
            onClicked: {
                if(flag==0){
                    ...
                    //song.text=song2name.text
                    flag=1
                     songClicked(song2name.text)
                }
                else if (flag==1){
        ...
        MouseArea{
            ...
            onClicked: {
                ...
                if(flag==0){
                    ...
                    //song.text=song3name.text
                    flag=1
                     songClicked(song3name.text)
                }
                else if (flag==1){
        ...
        MouseArea{
            ...
            onClicked: {
                if(flag==0){
                   ...
                   // song.text=song4name.text
                    flag=1
                     songClicked(song4name.text)
                }
                else if (flag==1){
        ...
        MouseArea{
            ...
            onClicked: {
                if(flag==0){
                   ...
                   // song.text=song5name.text
                    flag=1
                     songClicked(song5name.text)
                }
                else if (flag==1){
