...
Rectangle{
    ...
    color:"black"
    property var flag :0
    signal vehiclesongClicked(string songName)
    Rectangle{
        id:nature
        ...
        MouseArea{
            ...
            onClicked: {
                if(flag==0){
                    ...
                    vehiclesongClicked(song2name.text)
                    flag=1
                }
                else if (flag==1){
        ...
        MouseArea{
            ...
            onClicked: {
                ...
                if(flag==0){
                    ...
                    vehiclesongClicked(song3name.text)
                    flag=1
                }
                else if (flag==1){
        ...
        MouseArea{
            ...
            onClicked: {
                if(flag==0){
                    ...
                    vehiclesongClicked(song4name.text)
                    flag=1
                }
                else if (flag==1){
        ...
        MouseArea{
            ...
            onClicked: {
                if(flag==0){
                    ...
                    vehiclesongClicked(song5name.text)
                    flag=1
                }
                else if (flag==1){
